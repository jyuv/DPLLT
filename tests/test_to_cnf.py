...
formulas_texts = ["!(x1 -> (x1 & x2))",
                  "x1 <-> (x2 -> x3)",
                  "(x1 & x2) | (x3 & x4)",
                  "!((!(x1 & x2)) -> (!x3))"
                  ]

formulas_nnf_texts = ["x1 & ((!x1) | (!x2))",
                      "((!x1) | ((!x2) | x3)) & ((x2 & (!x3)) | x1)",
                      "(x1 & x2) | (x3 & x4)",
                      "((!x1) | (!x2)) & x3"
                      ]

formulas_cnf_texts = ["x1 & ((!x1) | (!x2))",
...
@pytest.mark.parametrize("formula_text, expected_nnf_text",
...
@pytest.mark.parametrize("formula_text, expected_cnf_text",
